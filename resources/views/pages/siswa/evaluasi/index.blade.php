...
<div class="overflow-y-scroll mt-8 relative flex flex-wrap h-[55vh] overflow-hidden">
    ...
    <div class="w-full flex flex-wrap px-6">
        <div class="w-full lg:w-1/2 m-auto">
            ...
            @if($evaluation->score < 75) <div class="flex justify-center mb-6" data-aos="fade-up"
                data-aos-anchor="#content" data-aos-delay="3000">
                <a href="{{ url('soal') }}"
                    class="py-2 px-10 bg-[#4BB15E] cursor-pointer text-white m-auto text-2xl rounded-full hover:opacity-80 hover:shadow-lg hover:scale-105 transition duration-500 font-bubbleWater">Mulai
                    Lagi</a>
        </div>
        @endif
    </div>
...
<div class="w-full px-6" data-aos="fade-up" data-aos-delay="0">
    ...
    <ul class="list-decimal text-style-primary ml-4" data-aos="fade-up" data-aos-anchor="#content"
        data-aos-delay="1500">
        <li>Klik “MULAI” untuk memulai menjawab soal</li>
