...
<div class="overflow-y-scroll mt-8 relative flex flex-wrap h-[55vh] overflow-hidden">
    <div class="w-full px-8 mb-10">
        ...
        <p class="text-style-primary text-justify" data-aos="fade-up" data-aos-delay="500">
            ...
            Laut Kaspia, Laut
            Hitam, Selat Bosporus, Selat Dardanella, Laut Tengah, Terusan Suez, dan Laut Merah di barat, serta
            dengan Selat Bering
        ...
        <p class="text-style-primary text-justify">
            ...
            region yaitu Asia Barat atau Asia Barat Daya (Asia Timur Tengah), Asia Tengah, Asia Timur, Asia Selatan,
            Asia Tenggara,
            dan Rusia. Masing-masing wilayah memiliki ciri atau karakteristik yang membedakannya dengan wilayah
            lainnya.
        </p>
