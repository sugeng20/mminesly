<div class="overflow-y-scroll mt-8 relative flex flex-wrap h-[55vh] overflow-hidden">
    <div class="w-full px-8 mb-10">
        ...
        <p class="leading-loose text-sm text-slate-900 lg:text-[18px] lg:leading-loose">
            ...
            dengan secara
            seksama untuk mengenal lebih jauh kondisi alam negara-negara ini sehingga dapat diketahui kondisi lokasi,
            iklim, bentuk
            muka bumi, geologi, flora dan fauna, sampai dengan kondisi penduduknya.
        </p>
