<div
    ...
    <span class="lg:text-3xl text-2xl text-[#622E2A] uppercase" style="font-family: 'BubbleWater'">Profil
        Pengembang</span>
</div>
    ...
    <div class="w-full px-6">
        ...
        <table class="text-primary-style lg:text-lg text-sm" data-aos="fade-up" data-aos-anchor="#content"
            ...
            <tr>
                ...
                <td>Pengembangan Multimedia Interaktif Berbasis Website ‘Interaksi Antar Negara Asia dan Negara lain
...
<div class="w-40 h-12 absolute -bottom-6 left-1/2 -translate-x-1/2 bg-cover bg-center flex justify-center items-center
    bg-[#F2BA70] rounded-full shadow-xl">

    <button onclick="prev()" class="hover:scale-125 duration-500 ease-in-out">
