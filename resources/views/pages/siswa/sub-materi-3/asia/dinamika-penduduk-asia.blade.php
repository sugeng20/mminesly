...
<div class="overflow-y-scroll mt-8 relative flex flex-wrap h-[55vh] overflow-hidden">
    <div class="w-full px-8 mb-10">
        ...
        <p class="text-style-primary" data-aos="fade-up" data-aos-delay="2500" data-aos-anchor="#content">
            ...
            • Asia Selatan bagian selatan didominasi ras Negroid, misalnya suku bangsa Dravida di India Selatan dan Sri
            Lanka.<br />
            • Asia Barat (Timur Tengah) bagian selatan, khususnya
            negara-negara di Semenanjung Arab (Yaman, Oman)
            didominasi ras Negroid.<br />
        ...
        <p class="text-style-primary" data-aos="fade-up" data-aos-delay="3000" data-aos-anchor="#content">
            ...
            di Asia
            kemudian menyebar ke berbagai wilayah di Asia dan dunia. Sejumlah agama kemudian dianut oleh banyak negara
            bahkan sampai
            dengan penjuru di wilayah seluruh dunia.
        </p>
