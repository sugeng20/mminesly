...
<div class="overflow-y-scroll mt-8 relative flex flex-wrap h-[55vh] overflow-hidden">
    <div class="w-full px-8 mb-10">
        ...
        <p class="text-style-primary">
            ...
            4) Asia Selatan bagian selatan didominasi ras Negroid, misalnya suku bangsa Dravida di India Selatan dan Sri
            Lanka.<br />
            5) Asia Barat (Timur Tengah) bagian selatan, khususnya
            negara-negara di Semenanjung Arab (Yaman, Oman)
            didominasi ras Negroid.<br />
            6) Asia Kecil, Asia Barat (Timur Tengah) bagian utara
