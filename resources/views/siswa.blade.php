...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,200;0,400;0,600;0,700;1,400;1,600;1,700&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <div class="flex">
        <aside
            class="lg:w-96 w-80 h-screen bg-cyan-600 -ml-96 absolute lg:relative lg:ml-0 overflow-hidden transition duration-500 ease-in-out">
        ...
        <section class="w-full">
            ...
            <article class="w-full bg-cyan-500 h-[88vh] bg-cover bg-center bg-no-repeat px-6 pt-6"
                ...
                <div class="px-4 rounded-lg h-[68vh] bg-white shadow-lg w-full flex flex-wrap">
                    <div class="w-1/2 px-6 m-auto">
                        <h1 class="text-center font-black leading-10 text-2xl mb-6">
